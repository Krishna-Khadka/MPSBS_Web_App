...
<footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="/admin">admin dashboard</a>.</strong>
    All rights reserved.
...
<script src="{{ asset('dashboard/custom_js/script.js') }}"></script>
...
<script src="https://cdn.ckeditor.com/ckeditor5/40.2.0/classic/ckeditor.js"></script>
  ...
  @stack('post-scripts')
  @stack('event-scripts')
  @stack('notice-scripts')
  @stack('team-scripts')
  @stack('school-profile-scripts')
